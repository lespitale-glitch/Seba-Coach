...
export const i18n = {
  es: {
    "meta-locale": "es_AR",
    "meta-title": "Sebastián Zamperoni | Entrenador de Triatlón, Running y Natación — Buenos Aires",
    "meta-og-desc": "Preparación en natación, running, ciclismo y triatlón de la mano de un entrenador que entiende tus tiempos. Planes premium por TrainingPeaks. Buenos Aires."
  },
  en: {
    "meta-locale": "en_US",
    "meta-title": "Sebastián Zamperoni | Triathlon, Running and Swim Coach — Buenos Aires",
    "meta-og-desc": "Swim, run, cycling and triathlon preparation with a coach who understands your schedule. Premium plans via TrainingPeaks. Buenos Aires."
  }
};
